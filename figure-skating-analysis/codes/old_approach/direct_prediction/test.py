...
input_video_file_path = input("please input video file path: ")

# Perform Single Prediction on the Test Video.
type1 = predict_single_action(input_video_file_path, SEQUENCE_LENGTH)
score = predict_score(input_video_file_path, SEQUENCE_LENGTH, type1)
